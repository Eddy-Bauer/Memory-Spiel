...
//die Klasse für eine Karte des Memory Spiels. Sie erbt von Button
public class MemoryKarte extends Button {
	//die Instanzvariabelen
	...
	class KartenListener implements EventHandler<ActionEvent>{
		...
		public void handle(ActionEvent arg0) {
			...
			if(umgedreht == false) {
				vorderseiteZeigen();
			//die Methode karteÖffnen() im Spielfeld aufrufen
			//übergeben wird dabei die Karte also die this-Referenz der äußeren Klasse 
			spielfeld.karteÖffnen(MemoryKarte.this);
		}
	}
}
...
public void backZeigen(boolean rausnehmen) {
...
//die Methode liefer die Position einer Karte
